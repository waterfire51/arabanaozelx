...
var orderDetail7 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "red", "textAlign": "center"};
var orderDetail8 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "red", "textAlign": "center"};
var quantity = 0;
var withShipment = 0;
var kargo = 81;
var platePrice = 0;
...
function closeModal(plateSymbol) {
  ...
  if (imgPosition == 'left1') {
    ...
    document.getElementById('pillow1').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
    ...
    document.getElementById('pillow2').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
    ...
    document.getElementById('pillow3').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
    ...
    document.getElementById('pillow4').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
    ...
    document.getElementById('pillow5').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
    ...
    document.getElementById('pillow6').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
    ...
    document.getElementById('pillow7').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
    ...
    document.getElementById('pillow8').src = "../inc_all/images/backPillow/"+plateSymbol+".png";
  }
...
function postDesign() {
  ...
  for (var t=1;t<=quantity;t++){
    ...
    $('div.orderSee'+t+'').append('<img id="pill'+t+'" src="../inc_all/images/backPillow/'+window["orderDetail"+t]["plateColor"]+'.png">');
...
function getPrice(price, q,shipment,campaign) {
  ...
  if(typeof(shipment) === 'undefined' || shipment === null) {
    ...
    if((price+shipment)>=price1) {kargo=shipment+platePrice;}
    else {kargo=price1 + price2 + price3;}
  }
