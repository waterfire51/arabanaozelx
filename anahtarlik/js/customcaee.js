...
var orderDetail1 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var orderDetail2 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var orderDetail3 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var orderDetail4 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var orderDetail5 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var orderDetail6 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var orderDetail7 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var orderDetail8 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "king_1", "plateColor": "tan", "textAlign": "center"};
var quantity = 0;
var withShipment = 0;
var kargo = 81;
var platePrice = 0;
...
var enterCnt7 = 0;
var enterCnt8 = 0;
var fontTextLine = ["plateT1","plateT2","plateT3","plateT4","plateT5","plateT6","plateT7","plateT8"];
...
function closeModal(plateSymbol) {
  ...
  if (imgPosition == 'left1') {
    ...
    document.getElementById('pillow1').src = "../inc_all/images/keychain/"+plateSymbol+".png";
    ...
    document.getElementById('pillow2').src = "../inc_all/images/keychain/"+plateSymbol+".png";
    ...
    document.getElementById('pillow3').src = "../inc_all/images/keychain/"+plateSymbol+".png";
    ...
    document.getElementById('pillow4').src = "../inc_all/images/keychain/"+plateSymbol+".png";
    ...
    document.getElementById('pillow5').src = "../inc_all/images/keychain/"+plateSymbol+".png";
    ...
    document.getElementById('pillow6').src = "../inc_all/images/keychain/"+plateSymbol+".png";
    ...
    document.getElementById('pillow7').src = "../inc_all/images/keychain/"+plateSymbol+".png";
    ...
    document.getElementById('pillow8').src = "../inc_all/images/keychain/"+plateSymbol+".png";
  }
...
//*************** renk için   burası mobil için yapılacak******************
  ...
  pillowText5.keyup(function () {
    ...
    // if(rows.length === textLengt && enterCnt4 === 0) {pillowText5.val(rows + "\n");}
  });
  ...
  beltText5.keyup(function () {
    ...
    $('.plateT5').html(beltText5.val().toLocaleUpperCase('tr-TR'));
    var rows = $(this).val();
    // if(rows.length < 2 && enterCnt5 === 1){enterCnt5 = 0;}
  ...
  beltText8.keyup(function () {
    ...
    var rows = $(this).val();
    // if(rows.length < 2 && enterCnt8 === 1){enterCnt8 = 0;}
    // if(rows.length === textLengt && enterCnt6 === 0) {beltText8.val(rows + "\n");}
  });
...
function fontDegis(gelenFont) {
  ...
  if (imgPosition == 'plateT1') {
    ...
    */
    ...
    pillowFont7.addClass('ff' + orderDetail7fontFamily);
...
function postDesign() {
  ...
  for (var t=1;t<=quantity;t++){
    ...
    divOrderSee.append('<div class="col-md-6 col-xs-12 col-sm-12 orderSee'+t+'"></div>');
    $('div.orderSee'+t+'').append('<img id="pill'+t+'" src="../inc_all/images/keychain/'+window["orderDetail"+t]["plateColor"]+'.png">');
  ...
  if (quantity<1){
    ...
    if (orderDetail1.text === '' || orderDetail1.text === 'PLAKALIK YAZISI GİR' ){
