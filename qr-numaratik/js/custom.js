...
var orderDetail1 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "red", "textAlign": "center"};
var quantity = 0;
var withShipment = 0;
var kargo = 81;
var platePrice = 0;
...
function imgRefresh(imageName)
{
  ...
  document.getElementById(imgID[0]).src='../inc_all/images/qr-dijital-numara/'+imgID[1]+'.jpg';
}
