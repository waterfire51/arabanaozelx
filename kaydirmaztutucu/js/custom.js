...
function postDesign() {
  ...
  divOrderSee.html('');
    ...
    $('div.orderSee1').append('<img id="pill1" src="../inc_all/images/antiSlipHolder/siliconePlate.png">');
    $('div.orderSee1').append('<div class="col-md-3 plaka-svg1">');
    $('div.plaka-svg1').append('<img id="myImg1" class="img-fluid img-height" src="../inc_all/figures/'+orderDetail1.symbol+'.svg">');
    if (pillowLines[1]==undefined) { pillowLines[1] = ''; }
    for (var x=1;x<3;x++){
      $('div.orderSee1').append('<span id="pillT1'+x+'" class="pillT1'+x+' plateText-div pTextH yazi5 text-uppercase ff'+orderDetail1.fontFamily+' fc-'+orderDetail1.textColor+' align-center">'+pillowLines[x-1]+'</span><br>');
    }
  if (quantity<1){
