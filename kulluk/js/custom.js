...
function postDesign() {
    ...
    $('div.orderSee1').append('<img id="pill1" src="../inc_all/images/ashpit/black.png">');
    $('div.orderSee1').append('<div class="col-md-3 plaka-svg1">');
    $('div.plaka-svg1').append('<img id="myImg1" class="img-fluid img-height" src="../inc_all/figures/'+window["orderDetail1"]["symbol"]+'.svg">');
...
function imgRefresh(imageName) {
    ...
    document.getElementById(imgID[0]).src='images/file/'+imgID[1]+'.jpeg';
}
