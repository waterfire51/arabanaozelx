...
var orderDetail = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var orderDetail2 = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var orderDetail3 = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var orderDetail4 = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var orderDetail5 = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var orderDetail6 = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var orderDetail7 = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var orderDetail8 = { "type": "isikli", "text": '', "textColor": "white", "fontFamily": "ethnocentric", "leftStyle": "flag_1", "rightStyle": "flag_2", "plateColor": "black", "textAlign": "center" };
var quantity = 0;
var platePrice = 0;
var withShipment = 26;
var Ccity = 0;
...
$(document).ready(function () {
  ...
  var plateText3 = $("textarea[name=isim3]");
  ...
  var plateText4 = $("textarea[name=isim4]");
  ...
  var plateText5 = $("textarea[name=isim5]");
  ...
  var plateText6 = $("textarea[name=isim6]");
  ...
  var plateText7 = $("textarea[name=isim7]");
  ...
  var plateText8 = $("textarea[name=isim8]");
...
$("#symbolModal").on("shown.bs.modal", function () {
  ...
  $.post("getFigureGroups.php", {}, function (returnValue) {
    ...
    $.each(jsonReturnValue, function (index, value) {
      ...
      $('#figureGroup').append('<li onClick="getFigures(\'' + groupName[0] + '\')"><a data-toggle="pill" href="#' + groupName[0] + '" class="headerButtonBG lazy"><img src="https://otodark.com/inc_all/figures/figuresGroup/' + value + '" class="imageWH"></a></li>');
    });
  });
});
...
function fontDegis(gelenFont) {
  ...
  if (imgPosition == 'plateT') {
    ...
    inputT_.addClass('ff' + orderDetail2.fontFamily);
    $('#fontModal').modal('hide');
    ...
    $.each(fontTypes, function (index, value) {
      inputT.removeClass('ff' + value);
      a.removeClass('ff' + value); inputT_.removeClass('ff' + value);
    });
    inputT.addClass('ff' + orderDetail3.fontFamily);
    a.addClass('ff' + orderDetail3.fontFamily);
    inputT_.addClass('ff' + orderDetail3.fontFamily);
    $('#fontModal').modal('hide');
    ...
    inputT_.addClass('ff' + orderDetail4.fontFamily);
    $('#fontModal').modal('hide');
    ...
    inputT_.addClass('ff' + orderDetail5.fontFamily);
    $('#fontModal').modal('hide');
    ...
    inputT_.addClass('ff' + orderDetail6.fontFamily);
    $('#fontModal').modal('hide');
    ...
    inputT_.addClass('ff' + orderDetail7.fontFamily);
    $('#fontModal').modal('hide');
    ...
    inputT_.addClass('ff' + orderDetail8.fontFamily);
...
function postDesign() {
  ...
  if (quantity < 1) {
    ...
    if (orderDetail.text === '' || orderDetail.text === 'RUHSAT KABI YAZISI İÇİN TIKLA') {
    ...
    if (orderDetail.text === '' || orderDetail.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail2.text === '' || orderDetail2.text === 'RUHSAT KABI YAZISI İÇİN TIKLA') {
      $('#message1').html('<span class="alert-danger">Lütfen yazmak istediğiniz yazıyı ürünün üstündeki yazı alanına tıklayarak yazınız.</span>');
      alert("Lütfen yazmak istediğiniz yazıyı ürünün üstündeki yazı alanına tıklayarak yazınız.")
    } else {
      $('#shipmentModal').modal('show');
    ...
    if (orderDetail.text === '' || orderDetail.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail2.text === '' || orderDetail2.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail3.text === '' || orderDetail3.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail4.text === '' || orderDetail4.text === 'RUHSAT KABI YAZISI İÇİN TIKLA') {
      $('#message1').html('<span class="alert-danger">Lütfen yazmak istediğiniz yazıyı ürünün üstündeki yazı alanına tıklayarak yazınız.</span>');
      alert("Lütfen yazmak istediğiniz yazıyı ürünün üstündeki yazı alanına tıklayarak yazınız.")
    } else {
      $('#shipmentModal').modal('show');
    ...
    if (orderDetail.text === '' || orderDetail.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      ...
      || orderDetail3.text === '' || orderDetail3.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail4.text === '' || orderDetail4.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail5.text === '' || orderDetail5.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail6.text === '' || orderDetail6.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail7.text === '' || orderDetail7.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail7.text === '' || orderDetail7.text === 'RUHSAT KABI YAZISI İÇİN TIKLA'
      || orderDetail8.text === '' || orderDetail8.text === 'RUHSAT KABI YAZISI İÇİN TIKLA') {
      $('#message1').html('<span class="alert-danger">Lütfen yazmak istediğiniz yazıyı ürünün üstündeki yazı alanına tıklayarak yazınız.</span>');
      alert("Lütfen yazmak istediğiniz yazıyı ürünün üstündeki yazı alanına tıklayarak yazınız.")
    } else {
      $('#shipmentModal').modal('show');
...
function yazikaybol8() {
  ...
  if (document.getElementById("plateT8").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
function yazikaybol7() {
  ...
  if (document.getElementById("plateT7").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
function yazikaybol6() {
  ...
  if (document.getElementById("plateT6").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
function yazikaybol5() {
  ...
  if (document.getElementById("plateT5").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
function yazikaybol4() {
  ...
  if (document.getElementById("plateT4").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
function yazikaybol3() {
  ...
  if (document.getElementById("plateT3").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
function yazikaybol2() {
  ...
  if (document.getElementById("plateT2").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
function yazikaybol() {
  ...
  if (document.getElementById("plateT").value == 'RUHSAT KABI YAZISI İÇİN TIKLA')
...
$('.bos-plaka-uzerine-gelecek-yazi-input').keyup(function () {
