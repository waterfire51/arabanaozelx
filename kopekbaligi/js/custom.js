...
var orderDetail1 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var orderDetail2 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var orderDetail3 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var orderDetail4 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var orderDetail5 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var orderDetail6 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var orderDetail7 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var orderDetail8 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "vehicle_mercedes", "plateColor": "black", "textAlign": "center"};
var quantity = 0;
var withShipment = 0;
var kargo = 81;
var platePrice = 0;
...
function closeModal(plateSymbol) {
  ...
  if (imgPosition == 'left1') {
    ...
    document.getElementById('pillow1-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow1-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
    ...
    document.getElementById('pillow2-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow2-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
    ...
    document.getElementById('pillow3-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow3-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
    ...
    document.getElementById('pillow4-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow4-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
    ...
    document.getElementById('pillow5-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow5-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
    ...
    document.getElementById('pillow6-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow6-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
    ...
    document.getElementById('pillow7-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow7-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
    ...
    document.getElementById('pillow8-1').src = "../inc_all/images/shark/"+plateSymbol+".png";
    document.getElementById('pillow8-2').src = "../inc_all/images/shark/"+plateSymbol+"-logo.png";
  }
...
function fillStates(id) {
  $.post("getStates.php", { id: id.value }, function (data) {
    ...
    if(Cstate != 0){var i = 0;
      $.each(dataJSON, function (index, value) {if(value.id == Cstate) {$("#state").prop('selectedIndex',i);}i++;});}
  });$('#state').focus();
}
// /********şehir ilçe
...
$("#symbolModal").on("shown.bs.modal", function () {
  ...
  $('figureGroup').html();
      $('#figureGroup').append('<li><a data-toggle="pill" href="#vehicle" class="headerButtonBG lazy"><img src="../inc_all/figures/figuresGroup/vehicle_1.svg" class="imageWH"></a></li>');
      getFigures("vehicle");
});
