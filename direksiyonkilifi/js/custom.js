...
var orderDetail1 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var orderDetail2 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var orderDetail3 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var orderDetail4 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var orderDetail5 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var orderDetail6 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var orderDetail7 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var orderDetail8 = {"type": "isikli", "text":'', "textColor": "white", "fontFamily": "ethnocentric", "symbol": "siyah", "plateColor": "taba", "textAlign": "center"};
var quantity = 0;
var withShipment = 0;
var kargo = 81;
var platePrice = 0;
...
function closeModal(plateSymbol) {
 ...
 if(imgPosition == 'right1') {
    ...
    document.getElementById('pillow1').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }else if(imgPosition == 'right2') {
    orderDetail2.plateColor = plateSymbol;
    document.getElementById('pillow2').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }else if(imgPosition == 'right3') {
    orderDetail3.plateColor = plateSymbol;
    document.getElementById('pillow3').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }else if(imgPosition == 'right4') {
    orderDetail4.plateColor = plateSymbol;
    document.getElementById('pillow4').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }else if(imgPosition == 'right5') {
    orderDetail5.plateColor = plateSymbol;
    document.getElementById('pillow5').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }else if(imgPosition == 'right6') {
    orderDetail6.plateColor = plateSymbol;
    document.getElementById('pillow6').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }else if(imgPosition == 'right7') {
    orderDetail7.plateColor = plateSymbol;
    document.getElementById('pillow7').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }else if(imgPosition == 'right8') {
    orderDetail8.plateColor = plateSymbol;
    document.getElementById('pillow8').src = "https://otodark.com/inc_all/images/steeringCover/"+plateSymbol+".png";
  }
...
function selectType(selectedType) {
  ...
  if (selectedType !== "isikli-1"){
    $('.plaka1').removeClass('margin-left-120');
    $('.plaka1').removeClass('margin-left-0');
    $('.plaka1').addClass('margin-left-0');
  } else{
    $('.plaka1').removeClass('margin-left-0');
    $('.plaka1').removeClass('margin-left-120');
    $('.plaka1').addClass('margin-left-120');
  }
  for (var i=1;i<5;i++) {
...
function imgRefresh(imageName)
{
  ...
  document.getElementById(imgID[0]).src='https://otodark.com/inc_all/images/steeringCover/'+imgID[1]+'.jpg';
}
